	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(api)/api/bookmarks/create/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(api)/api/bookmarks/get_url/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(api)/api/localAuth/auth/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(api)/api/localAuth/register/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(api)/api/localAuth/verify/_server.ts.js'))
			},
			{
				id: "/(main)/b",
				pattern: /^\/b\/?$/,
